    ...
    <header className="fixed top-5 left-0 right-0 z-50 flex justify-center px-4 sm:px-6 pointer-events-none">
      <div className="w-full max-w-6xl glass-pill rounded-full px-5 py-2.5 sm:px-7 sm:py-3 flex items-center justify-between pointer-events-auto transition-all duration-300">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-tr from-[#dfcfbd] via-[#c9a978] to-[#997746] text-[#090b10] shadow-sm transition-transform duration-300 group-hover:scale-105">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <Link
            href="/submit-product"
            className="flex items-center gap-1.5 rounded-full bg-[#f4ede4] hover:bg-white text-[#090b10] px-5 py-2 text-xs font-bold tracking-wide shadow-md transition-all duration-300 hover:scale-[1.03] active:scale-95"
          >
        ...
        <div className="flex sm:hidden items-center gap-2">
          <Link
            href="/submit-product"
            className="rounded-full bg-[#f4ede4] text-[#090b10] px-3.5 py-1.5 text-xs font-bold"
          >
            Submit
          </Link>
          <button
        ...
        <div className="absolute top-16 left-4 right-4 sm:hidden glass-pill rounded-3xl p-5 space-y-4 pointer-events-auto shadow-2xl animate-in slide-in-from-top-2">
          ...
          <div className="pt-2 border-t border-white/10">
            <Link
              href="/submit-product"
              onClick={() => setMobileMenuOpen(false)}
              className="flex w-full items-center justify-center gap-1.5 rounded-full bg-[#f4ede4] text-[#090b10] py-2.5 text-xs font-bold tracking-wide"
            >
              <span>Submit Product</span>
